...
import { LinkItem, Category, ContentType } from "@/types/blog";
import { getLinkItems, saveLinkItems } from "@/lib/store";
        ...
        <div className="border border-gray-200 p-5 space-y-4 bg-white">
          ...
          <form onSubmit={handleItemSubmit} className="space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                <label className="font-bold text-gray-800">ピンポイント元URL</label>
                <input
                  type="url"
                  value={sourceURL}
